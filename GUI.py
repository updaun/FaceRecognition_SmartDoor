...
imgLabel1 = Label(root, image=photoimage1, width=50,
                  height=50, background='#FFFFDE')
...
btn2 = Button(root, text="체험자 사진 촬영", width=20, height=1, font=font,
              foreground='white', background='#2f3640', command=lambda: shot(textExample.get()))
btn3 = Button(root, text="인공지능 학습", width=20, height=1, font=font, foreground='white',
              background='#2f3640', command=lambda: train(textExample.get()))
btn4 = Button(root, text="스마트 도어 작동", width=20, height=1, font=font,
              foreground='white', background='#2f3640', command=lambda: lock(textExample.get()))
...
label1 = Label(root, text='Step 1. 체험자의 이름을 영어로 입력하세요.', anchor="sw",
...
label2 = Label(root, text='Step 2. 인공지능 학습을 위한 사진을 촬영하세요.', anchor="sw",
               width=40, height=1, font=font1, background='#FFFFDE', padx=100)

label3 = Label(root, text='Step 3. 체험자의 사진을 학습시켜주세요.', anchor="sw",
               width=40, height=1, font=font1, background='#FFFFDE', padx=100)

label4 = Label(root, text='Step 4. 스마트 도어를 작동해주세요.', anchor="sw",
               width=40, height=1, font=font1, background='#FFFFDE', padx=100)

label5 = Label(root, text='Step 5. 다음 체험자를 위해 사진을 삭제해주세요.', anchor="sw",
               width=40, height=1, font=font1, background='#FFFFDE', padx=100)
...
textExample = Entry(root, width=18, font=font2,
