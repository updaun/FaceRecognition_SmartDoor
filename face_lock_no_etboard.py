...
def lock(name):
    ...
    if  name == '':
        ...
        messagebox.showwarning("스마트 도어 시스템","학습 대상과 이름이 일치하지 않습니다.\n \n다시 사진을 촬영해주세요.")

    elif os.path.isfile('./dataset/'+name+'/user1.jpg') == False:
        print('[오류] 학습 시킬 데이터가 없습니다. 다시 사진을 촬영해주세요.\n')
        messagebox.showwarning("스마트 도어 시스템","학습 시킬 데이터가 없습니다.\n다시 사진을 촬영해주세요.")
        ...
        messagebox.showinfo("스마트 도어 시스템","'확인' 버튼을 누르면 체험을 시작합니다.\n \n체험 중 [ 스페이스바 ] 를 누르면 체험을 중단할 수 있습니다.")
        ...
        while True:
            ...
            try:
                ...
                if confidence > 87:
                    ...
                    display_string = '[ 출입 허용 ]   '+ name +'   '+ str(confidence)+'%'
                    image = cv2.resize(image,(500,500))
                    image = cv2.flip(image, 1)
                    cv2.rectangle(image, (75,75),(75+350,75+350),(0,255,0),2)
                    ...
                    cv2.moveWindow("Smart Door System, Press  SPACE  key to exit", 545, 0)
                ...
                #85 이하면 타인.. Locked!!!
                    ...
                    image = cv2.resize(image,(500,500))
                    image = cv2.flip(image, 1)
                    cv2.rectangle(image, (75,75),(75+350,75+350),(0,0,255),2)
                    img_pil = Image.fromarray(image)
                    draw = ImageDraw.Draw(img_pil)
                ...
                cv2.rectangle(image, (75,75),(75+350,75+350),(255,255,255),2)
